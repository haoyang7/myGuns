    ...
    $WebUpload.prototype = {
        ...
        create: function () {
            var webUploader = WebUploader.create({
                ...
                accept: {
                    title: 'Images',
                    extensions: 'gif,jpg,jpeg,bmp,png,x-flv,mp4,x-mpegURL,MP2T,3gpp,quicktime,x-msvideo,x-ms-wmv',
                    mimeTypes: 'image/gif,image/jpg,image/jpeg,image/bmp,image/png,video/x-flv,video/mp4,application/x-mpegURL,video/MP2T,video/3gpp,video/quicktime,video/x-msvideo,video/x-ms-wmv'
                },
                swf: Feng.ctxPath
